<footer class="page-footer" style="background-color: black;">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Fashion Sense.<br>
				JVPD Juhu Scheme Andheri west Mumbai
			</address>
				<div class="phone">
					Telephone:
				...
				<div class="email">
					Email:
					<a href="mailto:govindthakur@gmail.com" class="email__addr">govindthakur@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2023 Fashion Sense&trade;
			</div>

			<div class="developer">
				Dev By Govind Thakur 
			</div>
